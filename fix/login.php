...
if (isset($_POST['login'])) {
    ...
    if ($user==$data['username'] && $pass==$data['password']) {
        ...
        $q ='Username yang Anda Masukkan Salah';
    }if ($pass!=$data['password']) {
        $q = 'Password yang Anda Masukkan Salah';
    }if($user!==$data['username'] && $pass!==$data['password']){
        $q = 'Username dan Password Salah';
    }
        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
              <img src="img/bussid.jpg" class="img-fluid"
                alt="Sample image">
            </div>
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                
            <div class="card-header text-center"><h1 style="color:blue;">LOGIN</h1>
            <?php if(isset($q)){ ?><span class="alert alert-danger"><?php echo $q; ?></span><?php } ?></div>
