                              ...
                              <div class="card-body">
                                <?php
                                    include 'inc/koneksi.php';
                                        $id = $_GET['id'];
                                        $data = mysqli_query($koneksi,"select * from catatan_perjalanan where id='$id'");
